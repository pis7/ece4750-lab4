...
#endif
                VL_FATAL_MT("utb_BranchGlobalCtrl.v", 21, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__entry_upper_reached = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__entry_lower_reached = VL_RAND_RESET_I(1);
