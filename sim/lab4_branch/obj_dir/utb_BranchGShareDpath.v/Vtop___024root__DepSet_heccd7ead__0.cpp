...
#endif
                VL_FATAL_MT("utb_BranchGShareDpath.v", 21, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("utb_BranchGShareDpath.v", 21, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("utb_BranchGShareDpath.v", 21, "", "NBA region did not converge.");
            }
