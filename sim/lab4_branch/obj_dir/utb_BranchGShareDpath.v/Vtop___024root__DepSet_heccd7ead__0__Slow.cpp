...
#endif
                VL_FATAL_MT("utb_BranchGShareDpath.v", 21, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__prediction = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__update_ghr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__increment_entry = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__decrement_entry = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT____Vtogcov__entry_upper_reached = VL_RAND_RESET_I(1);
    vlSelf->top__DOT____Vtogcov__entry_lower_reached = VL_RAND_RESET_I(1);
    vlSelf->top__DOT____Vtogcov__update_ghr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT____Vtogcov__increment_entry = VL_RAND_RESET_I(1);
    vlSelf->top__DOT____Vtogcov__decrement_entry = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__unnamedblk1__DOT__i = 0;
    VL_RAND_RESET_W(4096, vlSelf->top__DOT__DUT__DOT__counts);
    ...
    vlSelf->top__DOT__DUT__DOT____VdfgTmp_h133b37bf__0 = 0;
